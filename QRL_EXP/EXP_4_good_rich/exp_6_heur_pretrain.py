...
handler = logging.FileHandler("./logs6/exp_1.log", "a")
...
"./Data6/gnnfeatures_dim_64/features_bracs_hact_2_classes_pna_"
    + data_type
    + "_train.csv"
...
rl_agent_data = {
    ...
    'pre_trained_model_path': './trained/nn_model_good_7.pt'
}
...
wandb_run = wandb.init(
    ...
    id = 'kozylft3',
    name = "exp_4_prev_best_pretrain_good_rich",
    project="QRL1_test",
    entity="ep19b005",
    resume='must',
)
...
filepath = "./json_objs6/exp_1.json"
