...
handler = logging.FileHandler("./logs3/exp_1.log", "a")
...
"./Data3/gnnfeatures_dim_64/features_bracs_hact_2_classes_pna_"
    + data_type
    + "_train.csv"
...
rl_agent_data = {
    ...
    'pre_trained_model_path': './trained/nn_model_bad_6.pt'
}
...
if rl_agent_data['use_pre_trained']:
    ...
    layer_9_w = ((torch.rand((n_actions,policy_net.layer6.in_features)) * (2* minimum))-minimum)
...
wandb_run = wandb.init(
    ...
    name = "exp_4_prev_best_pretrain_bad_rich",
    project="QRL1_test",
    entity="ep19b005",
    resume=True,
)
...
filepath = "./json_objs3/exp_1.json"
